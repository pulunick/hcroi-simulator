...
| `npm test`      | ✅ 11 파일 / 206 passed (formulas · scenario · insights · period · rollup · excel · pdf table · locate · detectPeriod · report data) + probe(skip)                                                                                                                                                                                                                                                                                                                                                                 |
| `npm run check` | ✅ 0 errors / 0 warnings (435 files)                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `npm run lint`  | ✅                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| git             | 원격 **github.com/pulunick/hcroi-simulator (public)**, 브랜치 **main** 9e44274 (push 2026-09-16). product/commercial 65de9e7 = main + `SITE_ENABLED=true`. 작업 트리 클린                                                                                                                                                                                                                                                                                                                                          |
