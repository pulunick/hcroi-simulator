...
| `npm run lint`  | ✅                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| git             | 원격 **github.com/pulunick/hcroi-simulator (public)**, 브랜치 **`product/commercial`** = main + `src/lib/site-config.ts` `SITE_ENABLED=true` 한 줄 (push 2026-09-16). 이 브랜치의 state.md 는 공개판 진행 상황만                                                                                                                                                                                                                                                                                                   |
