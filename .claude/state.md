...
| `npm run lint`  | ✅                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| git             | 원격 **github.com/pulunick/hcroi-simulator (public)**, 브랜치 **main** b900b07 (push 2026-09-16) + **미커밋: 공개판 겉면 정리(세션 13)**. product/commercial 6ef9bd2 = main + `SITE_ENABLED=true`                                                                                                                                                                                                                                                                                                                  |
